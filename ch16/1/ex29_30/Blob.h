...
template <typename T>
Blob<T>::Blob() : data(My_shared_ptr<std::vector<T>>(std::vector<T>())) { }

template <typename T>
Blob<T>::Blob(std::initializer_list<T> il) :
    data(My_shared_ptr<std::vector<T>>(std::vector<T>(il))) { }

//template <typename T>
//template <typename It>
//Blob<T>::Blob(It b, It e)
//    : data(My_shared_ptr<std::vector<T>>(std::vector<T>(b, e))) {}
